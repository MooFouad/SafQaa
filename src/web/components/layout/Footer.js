                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <p>Copyright &copy; 2024 SafQa ECommerce App. All Rights Reserved By <a href="https://web.facebook.com/nashad.mehsud" target="_blank" rel="noopener noreferrer">Basyouni Saad</a></p>
                            </div>
